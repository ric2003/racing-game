...
on the four forest-style circuits. A moving freight train runs outside each forest-style
...
Harbor and desert maps omit both the train and volcano. Harbor retains mountains;
Desert Endurance uses nine sand-colored, square-based pyramids on the horizon.
